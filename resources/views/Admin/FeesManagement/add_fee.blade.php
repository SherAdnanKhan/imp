   ...
   <div class="col-md-8">
      <div class="card m-b-30 card-body">
         ...
         <table class="table table-striped table-bordered table-hover example dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
            <thead>
               <tr role="row">
               <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Class: activate to sort column ascending" style="width: 255px;">Fee Name</th>
               <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Sections: activate to sort column ascending" style="width: 341px;">Classes</th>
                  ...
                  <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Class: activate to sort column ascending" style="width: 255px;">Shift</th>
            ...
            @foreach($getfeecat as $getfc)
               <tr id="row{{$getfc->FEE_CAT_ID}}">
                  <td class="mailbox-name"> {{$getfc->CATEGORY}}</td>
                  <td class="mailbox-name"> {{$getfc->CLASS_ID}}</td>
                  <td class="mailbox-name"> {{$getfc->SECTION_ID}}</td>
                  <td class="mailbox-name"> {{$getfc->SHIFT==1?'Morning':'Evening'}}</td>
              ...
              var type = data.SHIFT==1?'Morning':'Evening';
                $('#displaydata').append(`
                     <tr id="row`+data.FEE_CAT_ID+`">
                        ...
                        <td class="mailbox-date pull-right">
                     <button value="`+data.FEE_CAT_ID+`" class="btn btn-default btn-xs editbtn" > edit </button>
                          </td>
                      </tr>`)
